  ...
  return (
    <div className="metamask-main-div">
      <div className="metamask-section1">
        ...
        <p className="metamask-content">
          It is open, gasless, multichain, and platform agnostic fashion. The
          open communication layer allows any crypto wallet/front end to tap
        ...
        <p className="metamask-content">
          If your wallet is connected to a dApp that uses Push protocol, you
          will see the notification alert on your screen.
        </p>{" "}
