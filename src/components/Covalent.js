  ...
  return (
    <div className="metamask-section1">
      ...
      <p className="metamask-content">
        ...
        about a particular blockchain, and the type of information included will
        vary depending on the architecture of the blockchain it serves.
      </p>
      <p className="metamask-content">
      ...
      <p className="metamask-content">
        ...
        businesses, and enthusiasts alike. You can use a block explorer to check
        the status of a transaction if you’re buying or selling crypto. You can
        also acquire information associated with your blockchain address,
        including your transaction history, the total value of the assets held
        at the address, the total amount of crypto received at the address, and
        the total amount of crypto sent from the address, among other data
        points.
      </p>
      <h2 className="metamask-small-title">Covalent</h2>
      <p className="metamask-content">
        Covalent provides a unified API bringing visibility to billions of Web3
        data points.
      </p>
      <p className="metamask-content">
